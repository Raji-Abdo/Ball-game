...
var z = 350;
var xi = 30;
var ruu = document.querySelector("move");
var tim = document.querySelector(".timer");
var con = document.querySelector("congrats");
var los = document.querySelector("lose");
var play = document.querySelector("play");
var points = 0;
var poi = document.querySelector("point");
...
function lose() {
  if (
    parseInt(ruu.style.marginLeft) >= 1840 ||
    parseInt(ruu.style.marginLeft) <= -100 ||
    parseInt(ruu.style.marginTop) >= 900 ||
    parseInt(ruu.style.marginTop) <= 0
  ) {
...
function ms() {
  ruu.style.backgroundImage = "url(img/messi.png)";
}
...
function rn() {
  ruu.style.backgroundImage = "url(img/ronaldo.png)";
}
